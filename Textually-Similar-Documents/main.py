...
def main():
    ...
    char_matrix, jaccard_similarities = shingling_docs.create_characteristics_matrix(clean_documents, True)
    ...
    # Find and Time Jaccard similarity estimate using LSH (threshold = .6)
    candidate_pairs = lsh.find_similar_documents(signature_matrix)
    print('Threshold, .8: Following pair represents the similar text files: ')
